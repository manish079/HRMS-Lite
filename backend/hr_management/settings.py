...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,hrms-lite-mthb.onrender.com').split(',')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='hr_management_db'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': None,  # No pagination for simple HR system
